#!/usr/bin/env python
import sys
#sys.path.insert(0, '/qfs/projects/sppsi/pope044/NN_potential/updated_schnet_code/schnetpack/src/')
...
def main(args):
    ...
    #dataset = ManyBodyData(args.datapath, available_properties=available_properties, 
    #                       collect_triples=True, cutoff=angle_cutoff,
    #                       environment_provider=environment_provider)
    #environment_provider = MBEnvironmentProvider(cutoff=train_args.cutoff,
     #                                            )
